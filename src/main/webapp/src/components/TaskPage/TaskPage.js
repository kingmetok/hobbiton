            ...
            <Box className={classes.taskPage}>
              ...
              <Box className={classes.progressBarWrapper}>
                {goalData.completed ? (
                  ...
                  <AutorenewIcon color="secondary" className={classes.icon} />
                )}
                ...
                <Button
                  ...
                  variant="contained"
                  disabled={
                    getDayToday() === goalData.dateLastProof ||
                    goalData.completed
                  }
                >
                  Done
            ...
            <Box className={classes.secondaryWrapper}>
              <Box className={classes.descriptionWrapper}>
                ...
                <Typography className={classes.descriptionText}>
                  ...
                  {goalData.dateLastProof}
                </Typography>
                <Typography className={classes.descriptionText}>
                  <span>Started at: </span>
                  {goalData.dateStarted}
                </Typography>
                <Typography className={classes.descriptionText}>
                  <span>Remaining time: </span>
                  {`${goalData.term - goalData.progress} days`}
                </Typography>
              </Box>
